	...
	return (
		<main className="min-h-screen bg-white p-8 font-sans">
			<div className="max-w-6xl mx-auto">
				<h1 className="text-4xl font-bold text-gray-900 mb-8">Наш каталог товаров</h1>

				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{products.map((product: any) => (
						<div key={product.id} className="bg-white rounded-xl shadow-sm border border-gray-100 cursor-pointer overflow-hidden hover:shadow-lg transition-shadow">
							...
							<div className="p-5">
								...
								{/* Исправлено с product.title на product.name */}
